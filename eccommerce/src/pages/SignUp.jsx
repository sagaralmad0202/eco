        ...
        <div className="signup-content">
          ...
          <div className="signup-form-wrapper">
            ...
            <div className="signup-social-grid">
              {/* Facebook */}
              <a href="#" className="signup-social-btn" id="signup-facebook-btn">
                <svg
              ...
              {/* Twitter */}
              <a href="#" className="signup-social-btn" id="signup-twitter-btn">
                <svg
                  className="signup-social-icon"
                  viewBox="0 0 24 24"
                  fill="none"
              ...
              {/* Google */}
              <a href="#" className="signup-social-btn" id="signup-google-btn">
                <svg
                  className="signup-social-icon"
                  viewBox="0 0 24 24"
                  fill="none"
