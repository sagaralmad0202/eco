                  ...
                  <div className="ml-3 flex flex-1 flex-col sm:ml-6 text-left">
                    ...
                    <div className="mt-auto flex items-end justify-between pt-4 text-sm">
                      ...
                      <button
                        ...
                        className="relative z-10 mt-3 flex items-center text-sm font-medium text-sky-600 hover:text-sky-500 disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        {removingItemId === item.id ? (
                          <>
                            <svg className="animate-spin -ml-1 mr-2 h-4 w-4 text-sky-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
