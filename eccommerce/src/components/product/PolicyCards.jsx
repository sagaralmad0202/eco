const POLICY_CARDS = [
  {
    bg: "bg-red-50 dark:bg-red-50/90",
    title: "Free shipping",
  ...
  {
    bg: "bg-sky-50 dark:bg-sky-50/90",
  ...
  {
    bg: "bg-green-50 dark:bg-green-50/90",
  ...
  {
    bg: "bg-amber-50 dark:bg-amber-50/90",
...
export default function PolicyCards({ className = "" }) {
  return (
    <div className={className}>
      <div className="relative grid grid-cols-1 gap-3 sm:grid-cols-2">
        {POLICY_CARDS.map((card) => (
          <div
            key={card.title}
            className={`flex flex-col rounded-2xl p-5 ${card.bg}`}
          >
            <div>{card.icon}</div>
