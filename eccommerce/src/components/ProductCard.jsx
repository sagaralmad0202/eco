  ...
  return (
    ...
    >
      ...
      <div className="group relative z-1 shrink-0 overflow-hidden rounded-3xl bg-neutral-50 dark:bg-neutral-800">
        ...
        <div className="nc-shadow-lg rounded-full flex items-center justify-center absolute top-[12px] start-[12px] px-[10px] py-[6px] text-[12px] bg-white dark:bg-neutral-900 text-neutral-700 dark:text-neutral-300">
          ...
          <span className="ms-[4px] leading-none">New in</span>
        </div>
        <button 
