...
>
  ...
  />
      ...
      <div
        className={`fixed inset-y-0 right-0 z-50 flex max-w-full lg:hidden ${
      ...
      >
        ...
        <aside
          className={`relative h-screen w-screen max-w-md overflow-hidden bg-white text-start align-middle transition duration-200 ease-in-out ${
            isMobileMenuOpen ? "translate-x-0" : "translate-x-full"
          }`}
        >
          <div className="flex h-full flex-col px-4 md:px-8">
            <header className="flex h-16 flex-shrink-0 items-center justify-between border-b border-neutral-900/10 md:h-20">
              <a href="/" className="flex shrink-0 text-neutral-950">
                <svg
                  width="112"
                  height="44"
                  viewBox="0 0 112 44"
