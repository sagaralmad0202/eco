...
| `name`        | `VARCHAR(100)` | `NOT NULL`                                       | Name (e.g. _Jackets, Women, Men, Beauty, Bags, Sport_) |
| `slug`        | `VARCHAR(100)` | `UNIQUE`, `NOT NULL`                             | URL slug (e.g. _jackets_, _beauty_)                    |
...
| `name`         | `VARCHAR(200)` | `NOT NULL`                                       | Title (e.g. _"Cashmere Sweater"_)                  |
| `slug`         | `VARCHAR(200)` | `UNIQUE`, `NOT NULL`                             | URL slug (e.g. _"cashmere-sweater"_)               |
...
| `badge`        | `VARCHAR(50)`  | `NULLABLE`                                       | Badge tag (e.g. _"New in"_, _"50% Discount"_)      |
...
| `title`          | `VARCHAR(100)`  | `NOT NULL`                                    | Combination title (e.g. _"Brown / L"_)                   |
| `colorName`      | `VARCHAR(50)`   | `NULLABLE`                                    | Color name (e.g. _"Black"_, _"Brown"_, _"Beige"_)        |
| `colorHex`       | `VARCHAR(20)`   | `NULLABLE`                                    | Color hex code (e.g. _`#000000`_, _`#C6BDB5`_)           |
| `size`           | `VARCHAR(20)`   | `NULLABLE`                                    | Size option (e.g. _"XXS"_, _"XS"_, _"M"_, _"L"_, _"XL"_) |
...
_Constraints:_ `UNIQUE(userId, productId)` prevents duplicate bookmarking.
...
_Constraints:_ `UNIQUE(cartId, variantId)` ensures quantity is incremented rather than creating duplicate lines.
...
| `orderNumber`        | `VARCHAR(50)`   | `UNIQUE`, `NOT NULL`                                                                                    | Human-readable ID (e.g. _"ORD-2026-000148"_)   |
...
| `variantTitle` | `VARCHAR(100)`  | `NOT NULL`                                                         | Immutable snapshot of variant (e.g. _"Brown / L"_) |
...
_Constraints:_ `UNIQUE(userId, productId)` prevents duplicate reviews from the same user on the same product.
...
| `code`          | `VARCHAR(50)`   | `UNIQUE`, `NOT NULL`            | Promo code string (e.g. _"SUMMER20"_)             |
